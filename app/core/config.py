...
class Settings(BaseSettings):
    ...
    BACKEND_CORS_ORIGINS: List[AnyHttpUrl] = ["http://localhost", "http://localhost:8080", "http://192.168.*.*:8080/", "https://myspanishtracker.com", "https://unruffled-pasteur-6120ac.netlify.app"]
